...
let loginURL = "https://strawberrynets-backend.herokuapp.com/login";
// logIn(loginURL,body);
...
async function updatedCartData(id, x) {
  try {
    ...
    let url = "https://strawberrynets-backend.herokuapp.com/cart/" + id;
    // console.log(url);
...
async function deleteOneData(id) {
  try {
    ...
    let url = "https://strawberrynets-backend.herokuapp.com/" + id;
    // console.log("id",url)
    let res = await fetch(url, {
      method: "DELETE",
      headers: {
